...
def gradient_check(x, theta, epsilon=1e-7):
    ...
    grad_approx = (J_plus - J_minus) / (2 * epsilon)        # Step 5
    ### END CODE HERE ###
    ...
    denaminator = np.linalg.norm(grad) + np.linalg.norm(grad_approx)   # Step 2'
    difference = numerator / denaminator                               # Step 3'
    ### END CODE HERE ###
